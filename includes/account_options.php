...
<div id="content">
    <form action="" method="post">
        <p><em>Separate individual tags and users with spaces.</em> You must have cookies and JavaScript enabled in
            order for filtering to work. Note that the user blacklist is case sensitive.</p>
            ...
            <table cellpadding="0" cellspacing="4">
                <tr>
                    <td>
                        ...
                        <p>Any post containing a blacklisted tag will be ignored. Note that you can also blacklist
                            ratings.</p>
                    </td>
                    <td>
                        <textarea name="tags" rows="20"
                                  cols="50"><?php $new_tag_list != "" ? print $new_tag_list : print str_replace('%20', ' ', str_replace("&#039;", "'", $_COOKIE['tag_blacklist'])); ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="users"
                               value="<?php $new_user_list != "" ? print $new_user_list : print str_replace('%20', ' ', str_replace("&#039;", "'", $_COOKIE['user_blacklist'])); ?>"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="cthreshold"
                               value="<?php ($new_cthreshold == "" && !isset($_COOKIE['comment_threshold'])) ? print 0 : $new_threshold != "" ? print $new_cthreshold : print $_COOKIE['comment_threshold']; ?>"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <input type="text" name="pthreshold"
                               value="<?php ($new_pthreshold == "" && !isset($_COOKIE['post_threshold'])) ? print 0 : $new_pthreshold != "" ? print $new_pthreshold : print $_COOKIE['post_threshold']; ?>"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <textarea name="my_tags" rows="30"
                                  cols="50"><?php $new_my_tags != "" ? print $new_my_tags : print str_replace("%20", " ", str_replace('&#039;', "'", $_COOKIE['tags'])); ?></textarea>
                    </td>
                </tr>
            </table>
        </div>
