...
if (isset($_POST['group_name']) && $_POST['group_name'] != "") {
        ...
        <table class="highlightable" style="font-size: 12px; width: 100%;">
            ...
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="delete_posts" <?php $row['delete_posts'] == true ? print 'checked=true' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="delete_comments" <?php $row['delete_comments'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="admin_panel" <?php $row['admin_panel'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="is_default" <?php $row['default_group'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="rnotes" <?php $row['reverse_notes'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="rtags" <?php $row['reverse_tags'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="fposts" <?php $row['delete_forum_posts'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="ftopics" <?php $row['delete_forum_topics'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="flock" <?php $row['lock_forum_topics'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="fedit" <?php $row['edit_forum_posts'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="fpin" <?php $row['pin_forum_topics'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="anotes" <?php $row['alter_notes'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="cupload" <?php $row['can_upload'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <input type="checkbox"
                           name="iadmin" <?php $row['is_admin'] == true ? print 'checked="true"' : print ''; ?>/>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <br/>
    If you are deleting a group, make sure there are no users in it or they will not have a group assigned to their
    account and a lot of stuff will break.
    <br/>
